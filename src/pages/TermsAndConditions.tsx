...
export default function TermsAndConditions() {
    return (
        <div>
            <Helmet>
                <title>Terms & Conditions | Section 6 Detailing</title>
            </Helmet>
            ...
            <Section bgColor="bg-white">
                <div className="text-zinc-800 max-w-7xl text-xl mx-auto px-4 md:px-12 lg:px-24 py-12 space-y-3 leading-relaxed">
                    ...
                    <p>
                        These Terms and Conditions (“Terms”) govern your use of SECTION 6 LLC’s auto detailing services, whether provided at our studio or via mobile service. By booking or using our services, you agree to these Terms.
                    </p>
                    ...
                    <p>
                        We take the utmost care when handling your vehicle. However, SECTION 6 LLC is not responsible for pre-existing damage, wear and tear, or damage caused by hidden defects. You acknowledge that certain services, such as paint correction, involve inherent risks.
                    </p>
                    ...
                    <p>
                        If you have any questions about these Terms, please contact us at <span className="font-semibold">steven.tran@section6detailing.com</span> or <span className="font-semibold">(425) 306-2183</span>.
                    </p>
                </div>
            </Section>
        </div>
