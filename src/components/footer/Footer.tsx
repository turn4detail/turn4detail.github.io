        ...
        <div className="w-full max-w-7xl flex flex-col md:flex-row md:justify-between md:items-start gap-8 text-left">
          ...
          <Column>
            ...
            <p>
              ...
              serve you with dedication and passion. Contact Turn 4 Detail today to
          ...
          <Column>
            ...
            <FooterBlock title="FOLLOW US">
              <div className="flex gap-4 mt-2">
                <a
                  href="https://www.instagram.com/turn4detail/"
                  target="_blank"
                ...
                <a
                  href="https://www.youtube.com/@section6detailing"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1 text-blue-500 hover:underline hover:text-white transition"
                >
          ...
          <Column>
            <FooterBlock title="CONTACT INFO">
              ...
              <p className="flex items-center gap-2 mt-2">
                ...
                <a href="mailto:steven@turn4detail.com" className="text-blue-500 hover:underline hover:text-white transition">
                  steven@turn4detail.com
                </a>
              </p>
            </FooterBlock>
